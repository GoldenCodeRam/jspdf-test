                                        ...
                                        text: [
                                            {
                                                ...
                                                text: `${Strings.titleBlock.certificationCityAndDate}\n`,
                                                alignment: 'right',
                                                bold: true,
                                                fontSize: fontSizes.tiny,
                                            },
                                            {
                                                text: `${fields.certificationCityAndDate.city} - ${dateToString(fields.certificationCityAndDate.date)}`,
                                                alignment: 'right',
                                                fontSize: fontSizes.tiny,
                                            },
                                        ],
                                ...
                                [
                                    {
                                        text: [
                                            {
                                                // Add line feed to the end of the line
                                                text: `${Strings.titleBlock.subtitle}\n`,
                                                bold: true,
                                                fontSize: fontSizes.small,
                                            },
                                            {
